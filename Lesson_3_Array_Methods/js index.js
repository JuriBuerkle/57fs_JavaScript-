...
// * map()-- метод для перебора массива
...
// ! filter()-- метод для фильтрации массива
...
// ! find()-- метод для поиска элемента в массиве
...
// ! slice()-- метод для вырезания части массива
...
// ! splice()-- метод для удаления/добавления элементов в массив
...
// ! reduce()-- метод для сворачивания массива
...
const sumOfNames = brothersNames.reduce((acc, el) => acc + "этот " + el + ", ", "Герои: " , "Удаляем");
